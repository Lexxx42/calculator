...
t = (0, 0, 0)
numb_type = -1
ALERT = 'Мария, Наталья вышла из нашего проекта и декларировала, что групповая работа - это не для нее.' \
        'Что сдавать она домашку не будет и отказывается от дальнейшего сотрудничества.' \
        'Это обусловлено ее тяжелой жизненной ситуацией, нервы подвели.' \
        'Мы с командой считаем, что она заслуживает отличной оценки ее вклада в этот проект.' \
        'https://gb.ru/users/3801203 - ее профиль в GB.'
